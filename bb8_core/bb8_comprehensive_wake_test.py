            ...
            async with BleakClient(device_address, timeout=10.0) as client:
                ...
                if write_chars:
                    ...
                    for i, cmd in enumerate(wake_commands):
                        for char_uuid in write_chars[:2]:  # Try first 2 characteristics
                            try:
                                print(
                                ...
                                print(f"    ⚠️  Command failed: {str(e)[:50]}...")
...
async def test_wake_replication_comprehensive():
    ...
    if bb54a_result == "major" or s33_result == "major":
        ...
        print("💡 Either wake-up failed, or wake-up doesn't affect BLE advertising.")
