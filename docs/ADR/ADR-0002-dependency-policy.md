...
date: 2025-08-22
status: Accepted
decision: Pin paho-mqtt to >= 2.0, < 3.0 with VERSION1 callbacks and PyYAML to >= 6.0.1; use project-local virtual environment for dev/test installing both runtime and dev dependencies.
author:
