...
- Ensure front-matter has keys: related (list), supersedes (list), last_updated (YYYY-MM-DD)
  * If last_updated missing, set it to the date field if present, otherwise to today.
- Replace occurrences of /Volumes/HA or /Volumes/ha -> /n/ha in the body text.
- Write a backup <file>.autofix.bak before modifying.
